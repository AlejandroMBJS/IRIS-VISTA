    ...
    <div className="rounded-xl border border-[#E4E1DD] bg-white shadow-sm">
      ...
      <div className="border-b border-[#E4E1DD] px-6 py-4">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#4BAF7E]/10">
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Auto Approval */}
        <div className="rounded-lg border border-[#E4E1DD] p-4">
          <label className="flex items-start gap-4 cursor-pointer">
            ...
            <div className="flex-1">
              <span className="block text-sm font-medium text-[#2C2C2C]">{t.autoApprove}</span>
              <span className="block text-sm text-[#6E6B67]">{t.autoApproveDesc}</span>
            </div>
          </label>
          ...
          {config.auto_approve_enabled && (
            <div className="mt-4 pl-15">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-[#6E6B67]">$</span>
                <input
                  type="number"
                  min={0}
                  step={100}
                  ...
                  className="w-32 rounded-lg border border-[#E4E1DD] bg-white px-4 py-2 text-sm text-[#2C2C2C] transition-all focus:border-[#75534B] focus:outline-none focus:ring-2 focus:ring-[#75534B]/20"
                />
                <span className="text-sm text-[#6E6B67]">{t.currency}</span>
              </div>
              <div className="mt-2 flex items-center gap-2 text-[#E08A4B]">
        ...
        {/* Approval Levels */}
        <div>
          <h3 className="mb-4 text-sm font-semibold text-[#2C2C2C]">{t.approvalLevels}</h3>
          <div className="space-y-3">
            {(config.approval_levels || []).map((level, index) => (
              <div
                key={index}
                className="flex items-center gap-4 rounded-lg border border-[#E4E1DD] p-4"
              >
                <div className="flex items-center gap-2">
                  <span className="text-sm text-[#6E6B67]">{t.upTo}</span>
                  <span className="text-sm text-[#6E6B67]">$</span>
                  <input
                    type="number"
                    min={0}
                    ...
                    className="w-28 rounded-lg border border-[#E4E1DD] bg-white px-3 py-2 text-sm text-[#2C2C2C] transition-all focus:border-[#75534B] focus:outline-none focus:ring-2 focus:ring-[#75534B]/20"
                  />
                  <span className="text-sm text-[#6E6B67]">{t.currency}</span>
                </div>
                <span className="text-[#E4E1DD]">|</span>
                <div className="flex-1">
                  <select
